...
import { ThermophysicalLabContent } from "./thermophysicalLabContent";
import styles from "./thermophysicalLabStyles.module.css";

type Props = {
    locale: Locale;
};

export default function ThermophysicalLabPage({ locale }: Props) {
    const c = ThermophysicalLabContent[locale];
            ...
            <section className={styles.sectionGrey}>
                <div className={styles.container}>
                    ...
                    <table className={styles.uncertaintyTable}>
                        <thead>
                            <tr>
                                <th>{locale === "tr" ? "Ölçüm Büyüklüğü" : "Measurand"}</th>
            ...
            <section className={styles.sectionWhite}>
                <div className={styles.container}>
                    ...
                    <p className={styles.sectionTextLight}>
                        {locale === "tr"
                            ? "Termofiziksel Özellikler Laboratuvarı, aşağıdaki sektörlerdeki kurum ve kuruluşlara kalibrasyon, ölçüm ve danışmanlık hizmetleri sunmaktadır."
