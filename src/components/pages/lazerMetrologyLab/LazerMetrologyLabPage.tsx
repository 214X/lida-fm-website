...
import { LazerMetrologyLabContent } from "./lazerMetrologyLabContent";
import styles from "./lazerMetrologyLabStyles.module.css";

type Props = {
    locale: Locale;
};

export default function LazerMetrologyLabPage({ locale }: Props) {
    const c = LazerMetrologyLabContent[locale];
    ...
    return (
        <>
            ...
            <section className={styles.sectionWhite}>
                <div className={styles.container}>
                    <p className={styles.sectionLabelLight}>{locale === "tr" ? "Testler" : "Testing"}</p>
            ...
            <section className={styles.sectionWhite}>
                <div className={styles.container}>
                    ...
                    <p className={styles.sectionTextLight}>
                        {locale === "tr"
                            ? "Lazer Metrolojisi Laboratuvarı, aşağıdaki sektörlerdeki kurum ve kuruluşlara test, analiz ve danışmanlık hizmetleri sunmaktadır."
